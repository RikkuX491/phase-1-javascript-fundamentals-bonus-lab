...
describe('index.js', function() {
  ...
  describe('loginValidationPhrase', function() {
    ...
    it("uses a ternary expression to set its value to 'Welcome alice123', if the value of the isAuthorized variable is true, otherwise sets its value to 'Invalid username or password!'", function() {
      ...
      expect(js).to.match(/const loginValidationPhrase[ \n]*=[ \n]*.+\?.+:.+/, 'Expected the use of the ternary operator');
    });
  ...
  describe('randomNumber', function() {
    ...
    it('is a random number generated by Math.random()', function() {
      expect(randomNumber);
      expect(js).to.match(/const randomNumber[ \n]*=[ \n]*.*Math.random()/, 'Expected randomNumber to be a random number generated by Math.random()');
    });
